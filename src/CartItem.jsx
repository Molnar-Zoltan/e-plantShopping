...
const CartItem = ({ onContinueShopping }) => {
  ...
  const handleDecrement = (item) => {
      item.quantity > 1 && dispatch(updateQuantity({ name: item.name, quantity: item.quantity - 1 }));
  };
  ...
  const handleCheckoutShopping = (e) => { // This function is not needed for the project
